      ...
      <div className="mx-auto max-w-3xl text-center">
        <Reveal>
          ...
          <p className="mx-auto mt-8 max-w-2xl text-2xl leading-snug font-semibold text-crema sm:text-3xl">
            Es un proceso vivo de acompañamiento estratégico para contribuir
            al desarrollo orgánico de tu proyecto cultural, desde la
        ...
        <Reveal>
          <p className="mx-auto mt-6 max-w-xl text-base leading-relaxed text-crema/70">
            ...
            sostiene, el proceso creativo se aliviana y se alinea con el
